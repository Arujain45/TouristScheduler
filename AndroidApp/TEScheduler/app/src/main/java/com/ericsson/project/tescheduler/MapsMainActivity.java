...
public class MapsMainActivity extends MenuedActivity implements OnMapReadyCallback{
    ...
    private TextView textOpeningStatus, textOpeningTime, textPrice, textWebsite;
    ...
    protected void onResume() {
        super.onResume();
        //TODO (re)load budget value data
        //TODO move camera to latest selected PI
    }
