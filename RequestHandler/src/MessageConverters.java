...
//		wbuilder.registerTypeAdapter(Answer.class, new AnswerAdapter());
    ...
    public final static Answers decisionSupportResponsefromJson(String response) {
    ...
    public final static ReasoningRequest reasoningRequestFromJson(String request) {
        GsonBuilder builder = new GsonBuilder();
